...
<blockquote class="twitter-tweet" data-dnt="true">
  <p lang="en" dir="ltr">
    ...
    #favourite BIG updates to my Attribute Table filtering script. Group logic,
    date ranges, saving filters, aggregates (SUM, MIN, MAX, AVG). Install like
    any other roam/js script. #favourite
